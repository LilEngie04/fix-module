...
class Timeline extends Action
{
    ...
    protected string $aclResource = "job_schedule_timeline";
    ...
    public function execute(): Page
    {
        ...
        ->getConfig()->getTitle()->prepend(__('Cron Scheduler Timeline'))
        ->addBreadcrumb(__('CronScheduler'), __('CronScheduler'));
        return $resultPage;
    }
}
